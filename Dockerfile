...
RUN apt-get update -y && \
    ...
    apt-get install -qqy unzip wget curl libcurl4 git ssh tar gzip ca-certificates libusb-1.0 libpng16-16 libgtk2.0-0 libwebkitgtk-1.0-0 libwebkitgtk-3.0-0 && \
    apt-get clean && \
